...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-vertexai-mlops.sh` on the terminal.
...
## Explore MLOps with Vertex AI

This asset enables you to explore MLOps with Vertex AI.
...
This asset enables you to perform the following activities:
 ...
 - Develop and deploy model using Vertex AI
